...
func (a Lost) Weight() int  { return 0 }
func (a Lost) Name() string { return "v1beta1.CardAPI/Replace(Lost)" }
func (a Lost) Run(r locustworker.Runner) (int, time.Duration, error) {
	...
	start := time.Now()
	got, err := c.Replace(cpb.ReplaceRequest_REASON_LOST)
