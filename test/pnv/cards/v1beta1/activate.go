...
func (a Activate) Weight() int  { return 0 }
func (a Activate) Name() string { return "v1beta1.CardAPI/Activate" }
func (a Activate) Run(r locustworker.Runner) (int, time.Duration, error) {
