...
type ActivateGetDetails struct {
	AuthConfig config.AuthConfig
	Headers    []string
}

func (a ActivateGetDetails) Weight() int  { return 0 }
func (a ActivateGetDetails) Name() string { return "v1beta1.CardAPI/Activate&GetDetails" }
func (a ActivateGetDetails) Run(r locustworker.Runner) (int, time.Duration, error) {
